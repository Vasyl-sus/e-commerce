...
class NewGiftConfig extends Component {
	constructor(props) {
		super(props)
    ...
    const { handleSubmit } = this.props;
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Konfigurator daril - dodajanje</h2>
        </header>
      	<form onSubmit={handleSubmit(this.createGiftConfigurator.bind(this))} >
