...
class NewStickyNote extends Component {
	constructor(props) {
		super(props)
	...
	createStickyNote(obj)
  {
    ...
    this.props.createNewStickyNote(obj);
    this.props.reset();
	}
    ...
    const { handleSubmit } = this.props;
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Dodaj sticky bar</h2>
        </header>
      	<form onSubmit={handleSubmit(this.createStickyNote.bind(this))} >
