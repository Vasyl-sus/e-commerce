...
import {getDailyStatistics, changedUTMStatistics, changedUTMStatistics1, getUTMStats, addExpense, editExpense } from '../../actions/statistics_actions';
...
class DailyStatistics extends Component {
    constructor(props) {
      ...
      this.state = {selectedStat: null, inputDate: inputDate, selectedStatuses: [], newModal: false, UTMStatsDetails: false, selectedCountries:[],
        ...
        <div className="content-wrapper container-fluid">
          <div className="row">
            <div className="col-md-12">
              <h2 className="box-title">Dnevni pregled</h2>
            </div>
          </div>
