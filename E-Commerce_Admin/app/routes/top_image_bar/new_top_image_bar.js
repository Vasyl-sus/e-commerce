...
class NewTopImageBar extends Component {
	constructor(props) {
		super(props)

		this.state = {preview:null, image:[], checked: false, languages:[]}
	}
  ...
  componentDidMount() {
    ...
    this.props.createNewBillboard(top_image_bar_data);
    ...
    const img_style = {
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Dodaj naslovni slider</h2>
        </header>
      	<form onSubmit={handleSubmit(this.newTopImageBar.bind(this))} >
