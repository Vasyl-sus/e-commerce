...
class NewTestimonial extends Component {
	constructor(props) {
		...
		this.state = {preview: null, image: [], images_preview: [], languages:[], instagram_images: []}
	}
  ...
  createNewTestimonial(obj)
  {
    ...
    obj.timeline_image = this.state.images_preview;
    obj.instagram_images = this.state.instagram_images;
    this.props.CreateTestimonial(testimonial_data);
    ...
    const img_style = {
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
      	...
      	<form onSubmit={handleSubmit(this.createNewTestimonial.bind(this))}>
