...
class EditMessageTemplate extends Component {
	...
	editMessageTemplate(obj)
  {
    obj = obj.toJS();
		this.props.editExistingMessageTemplate(obj);
	}
    ...
    return (
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Uredi template-a</h2>
        </header>
      	<form onSubmit={handleSubmit(this.editMessageTemplate.bind(this))} >
