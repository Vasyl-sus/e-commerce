...
class EditUserTestimonial extends Component {
	constructor(props) {
		super(props)
  ...
  componentDidUpdate() {
    var initialValues = this.props.initialValues?.toJS();
    if (initialValues?.image && !this.state.preview) {
      this.setState({
 ...
 editUserTestimonial(obj)
  {
    ...
    testimonial_data.append("active", obj.active);
    ...
    this.props.EditUserTestimonial(initialValues.id, testimonial_data);
    this.props.reset();
  }
    ...
    const img_style = {
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
      	...
      	<form onSubmit={handleSubmit(this.editUserTestimonial.bind(this))}>
