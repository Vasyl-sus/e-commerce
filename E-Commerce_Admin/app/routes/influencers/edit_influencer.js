...
class EditInfluencer extends Component {
  ...
  componentDidMount()
  {
    let initial = this.props.initialValues.toJS();
    this.setState({profile_image: this.props.profile_image, type: this.props.type, date_from: new Date(initial.date_from)})
  };
    ...
    // console.log(obj);
    this.props.EditInfluencer(obj, influencer_data);
	}
    ...
    if (typeValue && (typeValue == "monthly" || typeValue.value == "monthly")) {
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Uredi influencerja1</h2>
        </header>
      	<form onSubmit={handleSubmit(this.editInfluencer.bind(this))} >
          <div className={`modal-body row`}>
            ...
            <div className="col-lg-6">
              ...
              { preview == null && this.state.profile_image ?
                <div className={`div-i-wrapper`}>
                  <img style={img_style} src={this.state.profile_image} />
                </div>
              : "" }
            </div>
          </div>
...
const selector = formValueSelector('EditInfluencerForm')
