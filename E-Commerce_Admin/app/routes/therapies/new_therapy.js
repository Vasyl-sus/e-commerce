...
class NewTherapy extends Component {
	constructor(props) {
		super(props)

		this.state = {preview:null, preview1:null, preview2:null, image:[], patern_image:[], background_image:[], languages:[]}
	}
  ...
  componentDidMount() {
    ...
    obj.title_color = obj.title_color ? obj.title_color.hex : "";
    ...
    therapy_data.append("date_added", obj.date_added);
    ...
    this.props.createNewTherapy(therapy_data);
    this.props.reset();
    ...
    const img_style = {
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Dodaj terapijo</h2>
        </header>
      	<form onSubmit={handleSubmit(this.createTherapy.bind(this))} >
...
function mapStateToProps(state) {
  ...
  return {
    formValues: nextState.form.NewTherapyForm && nextState.form.NewTherapyForm.values
  }
}
