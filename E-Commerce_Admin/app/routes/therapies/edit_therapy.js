...
class EditTherapy extends Component {
    ...
    display_image:null, p_image:null, b_image:null, display_image_id:null, p_image_id:null, b_image_id:null, hideProfile:'',
    hidePattern:'', hideBackground:'', languages:[]}
	}
  ...
  componentDidMount()
  {
    ...
    if(this.state.image.length != 0)
    {
      therapy_data.append("display_image", this.state.image);
		...
		this.props.EditExistingTherapy(obj, therapy_data);
	}
    ...
    const img_style = {
      ...
      style={otherModalStyles}>
        ...
        <header className={`confirm_box clearfix`}>
          <h2 className="center">Uredi terapijo</h2>
        </header>
      	<form onSubmit={handleSubmit(this.editTherapy.bind(this))} >
...
function mapStateToProps(state) {
  ...
  return {
    formValues: nextState.form.EditTherapyForm && nextState.form.EditTherapyForm.values
  }
}
