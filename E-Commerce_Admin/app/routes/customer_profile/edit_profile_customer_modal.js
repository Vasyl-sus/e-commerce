...
class EditProfile extends Component {
  ...
  componentDidMount()
  {
    this.setState({activeStar: this.props.customer_rating, isShippings: false})
  };
	...
	editProfile(obj)
  {
    ...
    this.props.EditCustomerProfile(obj);
    console.log(obj);
	}
  ...
  openShippings = () => {
    ...
    if (!this.state.isShippings === false && this.props.customerFormValues) {
      this.props.dispatch(change("EditCustomerProfileForm", "shipping_first_name", this.props.customerFormValues.first_name))
      this.props.dispatch(change("EditCustomerProfileForm", "shipping_last_name", this.props.customerFormValues.last_name))
      this.props.dispatch(change("EditCustomerProfileForm", "shipping_address", this.props.customerFormValues.address))
      this.props.dispatch(change("EditCustomerProfileForm", "shipping_postcode", this.props.customerFormValues.postcode))
      this.props.dispatch(change("EditCustomerProfileForm", "shipping_city", this.props.customerFormValues.city))
      this.props.dispatch(change("EditCustomerProfileForm", "shipping_country", this.props.customerFormValues.country))
    }
  }
      ...
      style={otherModalStyles}>
        ...
        <form onSubmit={handleSubmit(this.editProfile.bind(this))} >
          <div className={`modal-body row`}>
            ...
            {/*<Field name="comment" place="Dodaj komentar" inputclass="col-lg-12" component={renderArea} label="Komentar"/>*/}
          </div>
