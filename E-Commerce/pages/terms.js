    ...
    return (
      <Layout
        ...
        <div className='container page-container'>
          <h1 className='main-page-title'>{language.terms.data.h1t1.value}</h1>
          <div className='page-title-border'></div>
        </div>
        <div className='container page-wrap'>
          {language.terms.data.h1_text1t1.value != '' && (
            <React.Fragment>
              <div className='row'>
          ...
          {language.terms.data.datas.map(this.renderSingleTerm)}
        </div>
...
Terms.getInitialProps = async function (context) {
