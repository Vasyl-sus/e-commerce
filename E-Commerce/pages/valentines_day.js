...
class ValentinesDayPage extends React.Component {
  constructor(props) {
    super(props)
  ...
  render() {
    ...
    return (
      <Layout
        ...
        country={country}
        currency={currency}>
        <div className='container-fluid valentines-page'>
            ...
            <div className='row'>
              <div className='col-12'>
                <img
                  ...
                  alt=''
                  src={language.valentines_day.data.mainImage.value}
                />
              </div>
            </div>
            <div className='row'>
              <div className='col-12'>
                <div
                  className='valentines-content'
                  dangerouslySetInnerHTML={{
                    __html: language.valentines_day.data.mainContent.value,
                  }}></div>
              </div>
            </div>
          </div>
...
ValentinesDayPage.getInitialProps = async function (context) {
...
export default connect(mapStateToProps, mapDispatchToProps)(ValentinesDayPage)
