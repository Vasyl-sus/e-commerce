  ...
  render() {
    ...
    return (
      <Layout
        ...
        country={country}
        currency={currency}>
        <div className='container-fluid halloween'>
            ...
            <div className='row'>
              <div className='col-12'>
                <img
                  ...
                  alt=''
                  src={language.halloween.data.mainImage.value}
                />
              </div>
            </div>
            <div className='row'>
              <div className='col-12'>
                <div
                  className='halloween-content'
                  dangerouslySetInnerHTML={{
                    __html: language.halloween.data.mainContent.value,
                  }}></div>
              </div>
            </div>
          </div>
...
HalloweenPage.getInitialProps = async function (context) {
...
export default connect(mapStateToProps, mapDispatchToProps)(HalloweenPage)
